...
const CTA = () => {
  return (
    ...
    className="bg-white h-full w-full dark:bg-gray-900 bg-cover">
    <div className="bg-black/25 w-full h-full grid py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        <div className="lg:px-24 px-2 lg:text-left text-center mr-auto place-self-center lg:col-span-7 text-light">
