  ...
  return (
    ...
    <div class="bg-black/25 w-full h-full grid py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        <div class="px-24 pb-24 mr-auto place-self-center lg:col-span-7 text-light">
            ...
            <Link href="/contatti" class="bg-main hover:bg-hover inline-flex items-center justify-center px-5 py-3 mr-3 text-base font-medium text-center rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900">
                Contattami
