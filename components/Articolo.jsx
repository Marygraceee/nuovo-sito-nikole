...
function Articolo({ articolo, correlato }) {
  const myPortableTextComponents = {
    types: {
      image: (props) => (<figure><img alt="Immagine articolo" className="rounded-xl shadow-xl w-[95%] mx-auto aspect-video object-cover" src={urlFor(props.value.asset)} /></figure>),
